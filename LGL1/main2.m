...
toc;
%%  Costate Map 
lambda1= lambda.eqnonlin(1:problem.N+1);
lambda2= lambda.eqnonlin(problem.N+2:(problem.N+1)*2);

omega1 = problem.weight';
...
nodesPlot = linspace(-1, 1, 20)';
statePlot = zeros(20, problem.ns);
% 拉格朗日插值
for i=1:problem.ns
    curState = stateMat(:, i);
